      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row w-full max-w-fit bg-white rounded-xl shadow-lg overflow-hidden">
         ...
         <Link
          ...
          to={`/meals`}
            className="w-full sm:w-auto px-8 py-4  text-gray-800 font-semibold rounded-r-xl sm:rounded-r-xl sm:rounded-l-none hover:bg-gray-700 hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-700"
